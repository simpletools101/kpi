      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
          <div className="col-span-2">
            ...
            <p className="text-sm text-gray-600 mb-2">On A Mission To Boost Engineers&apos; Productivity.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/company" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                  Company
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link href="https://github.com" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                GitHub
              </Link>
            </div>
          </div>
